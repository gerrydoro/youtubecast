...
}:
{
  ...
  "@tanstack/react-router@1.170.3" = fetchurl {
    url = "https://registry.npmjs.org/@tanstack/react-router/-/react-router-1.170.3.tgz";
    hash = "sha512-WG3CZIMUmwL85aCswazWVgGoGkzSNUxAT66BraJY02Jrjs3mLSBHHNqoZuuAHUeH5MnakTKPva8k974+x6YseQ==";
  };
  ...
  "@tanstack/router-core@1.171.1" = fetchurl {
    url = "https://registry.npmjs.org/@tanstack/router-core/-/router-core-1.171.1.tgz";
    hash = "sha512-ItrosN74HMhp6ia12rhw7V0vH85/SWHBupvTas/YN/fKh8bDQbiLntc0L/CcBaUilCyJANVkFkvEnFMKcibocg==";
  };
  ...
  "react-hook-form@7.76.0" = fetchurl {
    url = "https://registry.npmjs.org/react-hook-form/-/react-hook-form-7.76.0.tgz";
    hash = "sha512-eKtLGgFeSgkHqQD8J59AMZ9a4uD1D83iSIzt4YlTGD7liDen5rrjcUO1rVIGd9yC1gofryjtHbv+4ny4hkLWlw==";
  };
